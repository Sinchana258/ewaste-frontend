...
export const blogs = [
  {
    ...
    description:
      "E-waste, the ever-growing mountain of discarded electronic devices, poses significant environmental challenges. Learn about its impact and solutions.",
    image:
  ...
  },
  {
    ...
    description:
      "Journey through the complete lifecycle of your electronic devices, from manufacturing to disposal, and understand their environmental impact at each stage.",
    image:
    ...
    content: {
      intro:
        "The environmental footprint of electronic devices extends far beyond their use phase. From resource extraction to manufacturing, distribution, usage, and finally disposal or recycling, each stage has unique environmental implications.",
    },
  },
  {
    id: 3,
    ...
    description:
      "Discover the proper ways to dispose of your electronic waste and why it matters for environmental preservation and resource conservation.",
    image:
  ...
  },
  {
    ...
    description:
      "Explore the toxic components in electronic devices and their potential health impacts when improperly disposed of or recycled without proper safeguards.",
    image:
      "https://images.unsplash.com/photo-1611284446314-60a58ac0deb9?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
    category: "Health",
    readTime: "7 min read",
  ...
  },
  {
    ...
    description:
      "Learn about cutting-edge technologies and processes used in modern e-waste recycling facilities to recover valuable materials and minimize environmental impact.",
    image:
      "https://images.unsplash.com/photo-1611284446314-60a58ac0deb9?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
    category: "Technology",
    readTime: "9 min read",
  ...
  },
  {
    ...
    description:
      "An in-depth look at how e-waste affects different countries and the global initiatives to combat this growing problem across developed and developing nations.",
    image:
  ...
  },
  {
    ...
    description:
      "How major tech companies are addressing e-waste through sustainable practices, take-back programs, and designing products with recycling in mind.",
    image:
  ...
  },
  {
    ...
    description:
      "Simple tips and guides to repair your electronics, extending their life and reducing e-waste generation while saving money and learning new skills.",
    image:
  ...
  },
  {
    ...
    description:
      "Exploring how valuable materials can be recovered from electronic waste through urban mining practices, turning waste into a valuable resource stream.",
    image:
      "https://images.unsplash.com/photo-1511502435191-fc0100a70333?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
    category: "Innovation",
  ...
  },
  {
    ...
    description:
      "Guidelines for responsible purchasing and usage of electronic devices to minimize waste generation and maximize the sustainability of your digital lifestyle.",
    image:
      "https://images.unsplash.com/photo-1610664921890-ebad05086414?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
    category: "Lifestyle",
    readTime: "7 min read",
  ...
  },
  {
    ...
    description:
      "Understanding the legal framework surrounding e-waste disposal and recycling in different regions and how these laws are evolving to address the growing challenge.",
    image:
  ...
  },
  {
    ...
    description:
      "Emerging trends and technologies that will shape the future of electronic waste management and recycling, from blockchain tracking to AI-powered sorting.",
    image:
      "https://images.unsplash.com/photo-1585909695284-32d2985ac9c0?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
    category: "Future",
    readTime: "10 min read",
...
// pick N random blogs
export const randomBlogs = (count) => {
...
export const getBlogsByCategory = (category) => {
  ...
  return blogs.filter(
    (blog) => blog.category && blog.category.toLowerCase() === lower
  );
};
...
export const getBlogsByTag = (tag) => {
  ...
  return blogs.filter(
    (blog) =>
      blog.tags &&
      blog.tags.some((t) => t.toLowerCase() === lower)
  );
};
